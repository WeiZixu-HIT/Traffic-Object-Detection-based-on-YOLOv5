...
class Ui_MainWindow(QtWidgets.QMainWindow):
    ...
    def setupUi(self, MainWindow):
        ...
        self.label_cls.setMinimumSize(QtCore.QSize(100, 60))
        self.label_cls.setMaximumSize(QtCore.QSize(100, 60))
        ...
        self.label_prb.setMinimumSize(QtCore.QSize(100, 60))
        self.label_prb.setMaximumSize(QtCore.QSize(100, 60))
        ...
        self.label_lefttoppos.setMinimumSize(QtCore.QSize(100, 60))
        self.label_lefttoppos.setMaximumSize(QtCore.QSize(100, 60))
        ...
        self.label_righttoppos.setMinimumSize(QtCore.QSize(100, 60))
        self.label_righttoppos.setMaximumSize(QtCore.QSize(100, 60))
        ...
        self.label_leftbottompos.setMinimumSize(QtCore.QSize(100, 60))
        self.label_leftbottompos.setMaximumSize(QtCore.QSize(100, 60))
        ...
        self.label_rightbottompos.setMinimumSize(QtCore.QSize(100, 60))
        self.label_rightbottompos.setMaximumSize(QtCore.QSize(100, 60))
        ...
        self.label_centerpos.setMinimumSize(QtCore.QSize(100, 60))
        self.label_centerpos.setMaximumSize(QtCore.QSize(100, 60))
        ...
        self.label_currentpt.setMinimumSize(QtCore.QSize(100, 60))
        self.label_currentpt.setMaximumSize(QtCore.QSize(100, 60))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_currentptleft.setText(_translate("MainWindow", "当前权重文件："))
    ...
    def button_model_open(self):
        ...
        self.__init__()
        self.label_infooutput.setText('成功切换权重文件为' + self.weights.split('/')[-1])
        self.label_currentpt.setText(self.weights.split('/')[-1])
            ...
            for i, det in enumerate(pred):
                if det is not None and len(det):
                    ...
                    for *xyxy, conf, cls in reversed(det):
                        ...
                        self.label_prb.setText(str(conf.numpy()))
                        ...
                        self.label_centerpos.setText('(' + str((c2[0]-c1[0])/2+c1[0]) + ',' + str((c2[1]-c1[1])/2+c1[1]) + ')')
