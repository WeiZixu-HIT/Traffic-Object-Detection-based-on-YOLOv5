...
class Ui_MainWindow(QtWidgets.QMainWindow):
    def __init__(self, parent=None):
        ...
        name = 'exp'
        save_file = 'C:/PythonProject/PycharmProject/yolov5-tag7-pyqt5/result'
        self.save_file = increment_path(Path(save_file) / name, exist_ok=False, mkdir=True)

        cudnn.benchmark = True
        weights = 'C:/PythonProject/PycharmProject/yolov5-tag7-pyqt5/weights/yolov5s.pt'  # 模型加载路径
    ...
    def setupUi(self, MainWindow):
        ...
        self.centralwidget.setStyleSheet("#centralwidget{border-image:url(C:/PythonProject/PycharmProject/yolov5-tag7-pyqt5/UI/xf46.png)}")
        ...
        #
        #     "QLabel{background-color: rgb(111, 180, 219)}"  # 背景颜色
        #     "QLabel{border: 1px solid white}"  # 边界颜色
        # )
        ...
        self.label_infooutput.setMinimumSize(QtCore.QSize(230, 60))
        self.label_infooutput.setMaximumSize(QtCore.QSize(230, 60))
        ...
        self.label_infooutput.setStyleSheet(
            ...
            "QLabel{border: 1px solid white}"  # 添加显示区域边框
        ...
        self.label_clsleft.setStyleSheet(
            "QLabel{background-color: rgb(204, 204, 255)}"  # 按键背景色
            "QLabel{color: rgb(93, 109, 126); font-weight: bold}"  # 字体颜色形状
            "QLabel{border: 1px solid white}"  # 添加显示区域边框
            "QLabel:hover{color: rgb(39, 55, 70); font-weight: bold;}"  # 光标移动到上面后的字体颜色形状
            "QLabel:pressed{background-color: rgb(23, 32, 42); font-weight: bold; color: rgb(135, 54, 0)}"
    ...
    def retranslateUi(self, MainWindow):
        ...
        MainWindow.setWindowTitle(_translate("MainWindow", "基于YOLOv5的目标检测软件"))
    ...
    def button_model_open(self):
        ...
        if fileName != '':
            # read cfg
            with open('C:/PythonProject/PycharmProject/yolov5-tag7-pyqt5/model.yaml') as f:
                cfg = yaml.load(f, Loader=yaml.SafeLoader)
            # update model_path
            cfg['model_path'] = fileName
            weights = cfg['model_path']
        else:
            weights = 'C:/PythonProject/PycharmProject/yolov5-tag7-pyqt5/weights/yolov5n.pt'
        self.model = DetectMultiBackend(weights, device=self.device)  #更换权重文件
        self.label_infooutput.setText('成功切换权重为' + weights.split('/')[-1])
        self.label_currentpt.setText(weights.split('/')[-1])
...
if __name__ == '__main__':
    ...
    # 设置窗口图标
    icon = QIcon()
    icon.addPixmap(QPixmap("C:/PythonProject/PycharmProject/yolov5-tag7-pyqt5/UI/icon.ico"), QIcon.Normal, QIcon.Off)
    # 设置应用图标
